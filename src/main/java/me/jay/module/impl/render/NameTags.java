...
@ModuleInfo(name = "NameTags", category = ModuleCategory.RENDER, description = "Render name tags above players", visable = false)
public class NameTags extends MirageModule implements Subscriber { }
